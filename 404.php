...
$fh = fopen('404_errors.log', 'a');
	$errortime = date("d M Y h:i:s");
	$message = "=========================== 404 Error Report ===========================\nA 404 error was encountered by $_SERVER[REMOTE_ADDR]";
	$message .= " on $errortime.\r\n";
	$message .= "The URI which generated the error is: " . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] . "\r\n";
	$message .= "The referring page was: $ref\r\n";
	$message .= "The used client was: " . $_SERVER['HTTP_USER_AGENT'] . "\r\n";
fwrite($fh, $message);
fclose($fh);
}
...
<font colspan="2" size="2" color="#000080" style="background: #c0c0c0" face="Fixedsys">&nbsp;FATAL ERROR&nbsp;</font>
</td></tr>
